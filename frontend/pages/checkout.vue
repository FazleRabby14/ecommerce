<template>
  <div class="bg-gray-50">
    <div class="mx-auto max-w-2xl px-4 pb-8 pt-2 sm:px-6 lg:max-w-7xl lg:px-8">
      ...
      <form class="lg:grid lg:grid-cols-2 lg:gap-x-12 xl:gap-x-16">
          ...
          <div class="mt-10 border-t border-gray-200">
            <h2 class="text-lg font-medium text-gray-900">Shipping information</h2>
             ...
             <!-- Radio buttons for personal or others -->

             <div class="flex flex-col mt-4 gap-y-4">
              <label class="text-black label-radio">
                <input type="radio" v-model="shippingType" value="personal" />
                Default Address
              </label>
              <p v-show="shippingType === 'personal'" class="text-black">&nbsp;&nbsp;&nbsp;&nbsp; Bashundhara R/A, G-Block, Road-07</p>

              <label class="text-black label-radio">
                <input type="radio" v-model="shippingType" value="others" />
                Other Address
              </label>

              <!-- Show this input when "Other Address" is selected -->
            ...
            <div v-if="shippingType === 'others'" class="mt-4 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-4">
            ...
            <fieldset class="mt-4">
              ...
              <div class="">
                <div v-for="(paymentMethod, paymentMethodIdx) in paymentMethods" :key="paymentMethod.id" class="flex items-center">
                  ...
                  <label :for="paymentMethod.id" class="ml-3 py-2 block text-sm font-medium text-gray-700">{{ paymentMethod.title }}</label>
                </div>
              </div>
            </fieldset>
<!--   
        ...
        <div class="mt-10 lg:mt-0">
          ...
          <div class="mt-4 rounded-lg border border-gray-200 bg-white shadow-sm">
            ...
            <div class="border-t border-gray-200 px-4 py-6 sm:px-6">
              <button type="submit" class="w-full rounded-md border border-transparent bg-wild-strawberry-600 px-4 py-3 text-base font-medium text-white shadow-sm hover:bg-wild-strawberry-700 focus:outline-none focus:ring-2 focus:ring-wild-strawberry-500 focus:ring-offset-2 focus:ring-offset-gray-50">Confirm order</button>
            </div>
          </div>
        </div>
       </div>
...
const shippingType = ref('personal');
    definePageMeta({
  layout: "main-layout",
  });
...
const products = [
  {
    ...
    color: 'Black',
    size: 'Large',
    imageSrc: 'https://allorabd.com/wp-content/uploads/2024/01/DSC_0382.jpg',
