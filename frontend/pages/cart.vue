    ...
    <div class="mx-auto max-w-2xl px-4 pb-24 pt-16 sm:px-6 lg:max-w-7xl lg:px-8">
      ...
      <form class="mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16">
        ...
        <section aria-labelledby="summary-heading" class="mt-16 rounded-lg bg-gray-50 px-4 py-6 sm:p-6 lg:col-span-5 lg:mt-0 lg:p-8">
          ...
          <!-- <div class="mt-6">
            <button type="submit" class="w-full rounded-md border border-transparent bg-wild-strawberry-600 px-4 py-3 text-base font-medium text-white shadow-sm hover:bg-wild-strawberry-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-50">Checkout</button>
          </div> -->

          <div class="mt-6">
          <!-- Use nuxt-link for internal navigation to the checkout page -->
          <nuxt-link to="/checkout" button type="submit" class="w-full rounded-md border border-transparent bg-wild-strawberry-600 px-4 py-3 text-base font-medium text-white shadow-sm hover:bg-wild-strawberry-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-50 text-center">
            Checkout
          </nuxt-link>
        </div>
...
const products = [
  {
    ...
    inStock: true,
    size: 'Large',
    imageSrc: 'https://allorabd.com/wp-content/uploads/2023/12/DSC_0223.jpg',
  ...
  },
  {
    ...
    leadTime: '3–4 weeks',
    size: 'Large',
    imageSrc: 'https://allorabd.com/wp-content/uploads/2023/12/DSC_0272-scaled.jpg',
  ...
  },
  {
    ...
    color: 'White',
    inStock: true,
    imageSrc: 'https://allorabd.com/wp-content/uploads/2022/02/12.jpg',
