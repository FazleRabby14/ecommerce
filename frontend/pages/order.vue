    ...
    <div class="bg-white">
      <div class="py-16 sm:py-24">
        ...
        <div class="mt-16">
          ...
          <div class="mx-auto max-w-7xl sm:px-2 lg:px-8">
            <div class="mx-auto max-w-2xl space-y-8 sm:px-10 lg:max-w-4xl lg:px-0 lg:px-20 xl:px-20">
                    ...
                    <div class="mt-6 sm:flex sm:justify-between">
                      ...
                      <div class="mt-6 flex items-center space-x-4 divide-x divide-gray-200 border-t border-gray-200 pt-4 text-sm font-medium sm:ml-4 sm:mt-0 sm:border-none sm:pt-0">
                        <div class="flex flex-1 justify-center">
                          <a :href="product.href" class="whitespace-nowrap text-wild-strawberry-600 hover:text-wild-strawberry-500">View product</a>
                        </div>
                        <div class="flex flex-1 justify-center pl-4">
                          <a href="#" class="whitespace-nowrap text-wild-strawberry-600 hover:text-wild-strawberry-500">Buy again</a>
                        </div>
                      </div>
                    </div>
                  </li>
