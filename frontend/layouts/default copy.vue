...
<template>
  <div class="bg-white">
    ...
    <header class="relative bg-white">
      <p class="flex h-10 items-center justify-center bg-wild-strawberry-600 px-4 text-sm font-medium text-white sm:px-6 lg:px-8">Get free delivery on orders over $100</p>
          ...
          <div class="flex h-16 items-center">
            ...
            <div class="ml-4 flex lg:ml-0">
              <a href="#">
                ...
                <img class="h-8 w-auto" src="F:\Ecom\frontend\logo.jpg" alt="" />
              </a>
            </div>
